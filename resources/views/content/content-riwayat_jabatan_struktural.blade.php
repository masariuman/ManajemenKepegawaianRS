                                    ...
                                    <div class="card-body"><h5 class="card-title">Masukan Riwayat Jabatan Struktural</h5>
                                        <form class="" action="" method="post">
                                            ...
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>Eselon</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="Contoh : II/a ditulis 2a" type="text" class="form-control" value=""></div>          
                                            </div>
                                            ...
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>Unit Kerja</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="Unit Kerja" type="text" class="form-control" value=""></div>          
                                            </div>
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>TMT Jabatan</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="TMT Jabatan" type="date" class="form-control" value=""></div>          
                                            </div>
                                            ...
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>Pejabat Pendatang SK</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="Pejabat Pendatang SK" type="text" class="form-control" value=""></div>          
                                            </div>
