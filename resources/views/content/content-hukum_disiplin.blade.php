                                    ...
                                    <div class="card-body"><h5 class="card-title">Masukan Data Hukum Disiplin</h5>
                                        <form class="" action="" method="post">
                                            ...
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>TMT BERLAKU</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="TMT BERLAKU" type="date" class="form-control" value=""></div>          
                                            </div>
                                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label"><b>Pejabat Pembuat SK</b></label>
                                                <div class="col-sm-10"><input name="title" id="exampleEmail" placeholder="Pejabat Pembuat SK" type="text" class="form-control" value=""></div>          
                                            </div>
