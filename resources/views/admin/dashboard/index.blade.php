            ...
            <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <div class="text-center titlepertab">Data SIKP Pegawai Yang Akan Habis</div>
                        <div class="margintop20">
                            <table class="mb-0 table table-striped table-bordered" id="datatable_anak">
                                <thead>
                                    <tr>
                        ...
                        <hr class="margintop50" />
                        <div class="text-center titlepertab">Data RKK Pegawai Yang Akan Habis</div>
                        <div class="margintop20">
                            <table class="mb-0 table table-striped table-bordered" id="datatable_anak">
                                <thead>
                                    <tr>
