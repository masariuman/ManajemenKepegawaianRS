@foreach ($diklat_fungsional as $no => $item)
    <div class="modal fade bd-example-modal-lg" id="riwayat_diklat_fungsional_show_{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Detail Data Riwayat Diklat Fungsional</h5>
