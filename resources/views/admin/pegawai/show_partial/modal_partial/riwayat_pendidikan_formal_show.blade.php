@foreach ($pendidikan_formal as $no => $data)
    <div class="modal fade bd-example-modal-lg" id="riwayat_pendidikan_formal_show_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
