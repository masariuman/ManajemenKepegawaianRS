@foreach ($diklat_teknis as $no => $item)
    <div class="modal fade bd-example-modal-lg" id="riwayat_diklat_teknis_show_{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
