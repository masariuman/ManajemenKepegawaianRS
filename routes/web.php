...
Route::get('/dasar_baru', 'dasarPegawaiController@create');
Route::post('/dasar_baru/tambah', 'dasarPegawaiController@store');
Route::get('/ubah', 'dasarPegawaiController@edit');
Route::patch('/update/{id}', 'dasarPegawaiController@update');
Route::patch('/delete', 'dasarPegawaiController@delete');
...
Route::get('/riwayat_diklat_fungsional/ubah', 'riwayatDiklatFungsionalController@edit');
Route::patch('/riwayat_diklat_fungsional/update/{id}', 'riwayatDiklatFungsionalController@update');
Route::patch('/riwayat_diklat_fungsional/delete', 'riwayatDiklatFungsionalController@delete');
...
Route::get('/riwayat_diklat_teknis/ubah', 'riwayatDiklatTeknisController@edit');
Route::patch('/riwayat_diklat_teknis/update/{id}', 'riwayatDiklatTeknisController@update');
Route::patch('/riwayat_diklat_teknis/delete', 'riwayatDiklatTeknisController@delete');
...
Route::get('/riwayat_diklat_penjenjangan-struktural/ubah', 'riwayatDiklatPerjenjanganStrukturalController@edit');
Route::patch('/riwayat_diklat_penjenjangan-struktural/update/{id}', 'riwayatDiklatPerjenjanganStrukturalController@update');
Route::patch('/riwayat_diklat_penjenjangan-struktural/delete', 'riwayatDiklatPerjenjanganStrukturalController@delete');
...
Route::get('/riwayat_kepangkatan/ubah', 'riwayatKepangkatanController@edit');
Route::patch('/riwayat_kepangkatan/update/{id}', 'riwayatKepangkatanController@update');
Route::patch('/riwayat_kepangkatan/delete', 'riwayatKepangkatanController@delete');
...
Route::get('/riwayat_jabatan_struktural/ubah', 'riwayatJabatanStrukturalController@edit');
Route::patch('/riwayat_jabatan_struktural/update/{id}', 'riwayatJabatanStrukturalController@update');
Route::patch('/riwayat_jabatan_struktural/delete', 'riwayatJabatanStrukturalController@delete');
...
Route::get('/riwayat_jabatan_fungsional/ubah', 'riwayatJabatanFungsionalController@edit');
Route::patch('/riwayat_jabatan_fungsional/update/{id}', 'riwayatJabatanFungsionalController@update');
Route::patch('/riwayat_jabatan_fungsional/delete', 'riwayatJabatanFungsionalController@delete');
...
Route::get('/istri-suami/ubah', 'istriSuamiController@edit');
Route::patch('/istri-suami/update/{id}', 'istriSuamiController@update');
Route::patch('/istri-suami/delete', 'istriSuamiController@delete');
...
Route::get('/anak/ubah', 'anakController@edit');
Route::patch('/anak/update/{id}', 'anakController@update');
Route::patch('/anak/delete', 'anakController@delete');
...
Route::get('/skp/ubah', 'skpController@edit');
Route::patch('/skp/update/{id}', 'skpController@update');
Route::patch('/skp/delete', 'skpController@delete');
...
Route::get('/seminar-lokakarya-simposium/ubah', 'seminarController@edit');
Route::patch('/seminar-lokakarya-simposium/update/{id}', 'seminarController@update');
Route::patch('/seminar-lokakarya-simposium/delete', 'skpContrseminarControlleroller@delete');
...
Route::get('/tanda_jasa-penghargaan/ubah', 'skpContpenghargaanControllerroller@edit');
Route::patch('/tanda_jasa-penghargaan/update/{id}', 'penghargaanController@update');
Route::patch('/tanda_jasa-penghargaan/delete', 'penghargaanController@delete');
...
Route::get('/hukum_disiplin/ubah', 'hukumanController@edit');
Route::patch('/hukum_disiplin/update/{id}', 'hukumanController@update');
Route::patch('/hukum_disiplin/delete', 'hukumanController@delete');
...
Route::get('/keanggotaan_organisasi/ubah', 'organisasiController@edit');
Route::patch('/keanggotaan_organisasi/update/{id}', 'organisasiController@update');
Route::patch('/keanggotaan_organisasi/delete', 'organisasiController@delete');
...
Route::get('/keluarga_kandung/ubah', 'keluargaKandungController@edit');
Route::patch('/keluarga_kandung/update/{id}', 'keluargaKandungController@update');
Route::patch('/keluarga_kandung/delete', 'keluargaKandungController@delete');
...
Route::get('/keluarga_istri-suami/ubah', 'keluargaIstriSuamiController@edit');
...
Route::get('/riwayat_pekerjaan-jabatan/ubah', 'riwayatJabatanTeknisController@edit');
